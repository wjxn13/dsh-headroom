...
var DEFAULT_PRICE_TABLE = {
  ...
  // covers 9-12 and 14-18 via two spans below
};
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["card"], children: [
      ...
      hasPriceTable(priceTable) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["priceSection"], children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["priceWindow"], children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceWindowStart"), value: priceTable.window?.startHour, onChange: (v) => {
            void priceScope?.set("priceTable", { ...priceTable, window: { ...priceTable.window, startHour: v } });
          } }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceWindowEnd"), value: priceTable.window?.endHour, onChange: (v) => {
            void priceScope?.set("priceTable", { ...priceTable, window: { ...priceTable.window, endHour: v } });
          } })
        ] })
