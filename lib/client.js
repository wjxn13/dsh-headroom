...
function HeadroomPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: HeadroomPanel_default["section"], "aria-label": t("title"), children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["statsCard"], children: [
      ...
      hasPriceTable(priceTable) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["moneyRow"], children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["moneyRow"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statValue"], children: formatCny(estimateSpend(stats.sessionSavedTokens, 0, stats.cacheHitRate / 100, pricesForModel(priceTable, modelId), isPeakHour(priceTable?.window))) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statLabel"], children: t("statSavedMoney") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["moneyRow"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statValue"], children: formatCny(estimateSpend(stats.lifetimeInputTokens, 0, stats.cacheHitRate / 100, pricesForModel(priceTable, modelId), isPeakHour(priceTable?.window))) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statLabel"], children: t("statLifetimeMoney") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["moneyRow"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statValue"], children: formatCny(estimateSpend(stats.tokensSaved, 0, stats.cacheHitRate / 100, pricesForModel(priceTable, modelId), isPeakHour(priceTable?.window))) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statLabel"], children: t("statLifetimeSavedMoney") })
        ] })
...
var zh = {
  ...
  "statSavedMoney": "\u6700\u8FD1 60 \u5206\u949F\u5DF2\u8282\u7701\u91D1\u989D\uFF08\u4F30\u7B97\uFF09",
  "statLifetimeMoney": "\u7D2F\u8BA1\u82B1\u8D39\u91D1\u989D\uFF08\u4F30\u7B97\uFF09",
  "statLifetimeSavedMoney": "\u7D2F\u8BA1\u5DF2\u8282\u7701\u91D1\u989D\uFF08\u4F30\u7B97\uFF09",
  "statCacheHit": "\u7F13\u5B58\u547D\u4E2D\u7387",
  "statRequests": "\u7D2F\u8BA1\u8BF7\u6C42\u6570",
...
var en = {
  ...
  "statSavedMoney": "Saved last 60 min (est.)",
  "statLifetimeMoney": "Total spent (est.)",
  "statLifetimeSavedMoney": "Total saved (est.)",
