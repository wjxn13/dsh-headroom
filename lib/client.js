          ...
          "button",
          {
            ...
            onClick: () => {
              if (hasPriceTable(priceTable)) {
                ...
                void priceScope?.set("priceTable", DEEPSEEK_V4_FLASH_PRICES);
              }
            },
