...
function hasPriceTable(table) {
  ...
  return [table.hitPeak, table.hitOffPeak, table.missPeak, table.missOffPeak, table.outputPeak, table.outputOffPeak].some((v) => typeof v === "number" && v >= 0);
}
...
function estimateSpend(inputTokens, outputTokens, hitRate, table, peak) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: HeadroomPanel_default["section"], "aria-label": t("title"), children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["statsCard"], children: [
      ...
      hasPriceTable(priceTable) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["moneyRow"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: HeadroomPanel_default["statValue"], children: formatCny(estimateSpend(stats.inputTokens, 0, stats.cacheHitRate / 100, priceTable, isPeakHour())) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: HeadroomPanel_default["statLabel"], children: [
          t("stat60minMoney"),
          isPeakHour() ? `\uFF08${t("peak")}\uFF09` : `\uFF08${t("offPeak")}\uFF09`
        ] })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["card"], children: [
          ...
          "button",
          {
            ...
            onClick: () => {
              if (hasPriceTable(priceTable)) {
                void priceScope?.unset("price");
              } else {
                void priceScope?.set("price", DEEPSEEK_V4_FLASH_PRICES);
              }
            },
      ...
      hasPriceTable(priceTable) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: HeadroomPanel_default["priceGrid"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceHitPeak"), value: priceTable.hitPeak, onChange: (v) => {
          void priceScope?.set("price", { ...priceTable, hitPeak: v });
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceHitOff"), value: priceTable.hitOffPeak, onChange: (v) => {
          void priceScope?.set("price", { ...priceTable, hitOffPeak: v });
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceMissPeak"), value: priceTable.missPeak, onChange: (v) => {
          void priceScope?.set("price", { ...priceTable, missPeak: v });
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceMissOff"), value: priceTable.missOffPeak, onChange: (v) => {
          void priceScope?.set("price", { ...priceTable, missOffPeak: v });
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceOutPeak"), value: priceTable.outputPeak, onChange: (v) => {
          void priceScope?.set("price", { ...priceTable, outputPeak: v });
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PriceField, { label: t("priceOutOff"), value: priceTable.outputOffPeak, onChange: (v) => {
          void priceScope?.set("price", { ...priceTable, outputOffPeak: v });
        } })
...
function apply(ctx) {
  ...
  const priceScope = ctx.settingsScope.bind({ namespace: "dsh-headroom" });
